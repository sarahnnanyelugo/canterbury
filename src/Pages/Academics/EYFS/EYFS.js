  ...
  return (
    <>
      <div className="eyfs-div">
        ...
        <div className="col-md-10 offset-md-1 elementary-details">
          <h2>The Elementary Campus</h2>
          <div className="d-md-flex">
            <div
              className="col-md-7"
              style={{ marginTop: "100px", paddingRight: "30px" }}
            >
              {" "}
              <Accordion defaultActiveKey="0" flush>
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    ...
                    <ul>
                      <li>
                        Core Lessons including fact fluency, problem solving,
                        math modeling including the use of
                        manipulatives/pictures, and mathematical explanations
                      </li>
                ...
                <Accordion.Item eventKey="1">
                  ...
                  <Accordion.Body>
                    <p>
                      ...
                      standards. The following assessments will be used
                      throughout the year and scholar performance will be
                      communicated to families through graded work packets,
                      Powerschool gradebook, and parent conferences. Scholar
                      performance on these assessments is the major determining
                      factor in promotion to the next grade level as these data
                      points show whether critical skills and grade level
                      foundations have been mastered.
                    </p>

                    <ul>
                      <li>
                        NWEA Measures of Academic Progress (MAP): Provides
                        normative data on scholars’ current skill levels in ELA
                        and Math as compared to grade level peers
                      </li>
                      <li>
                        Expeditionary Learning and Eureka Assessments: Provide
                        authentic assessments on grade level standards based on
                      ...
                      <li>
                        DIBELS/Running Records: Progress monitoring tools used
                        to track scholar progress in-between major assessment
                ...
                <Accordion.Item eventKey="2">
                  ...
                  <Accordion.Body>
                    <p>
                      LECES strives to offer scholars performing above grade
                      level the push that they need to continue to grow on their
                      own academic journey. Below is the basic foundation that
                      we provide for such scholars:
                    </p>
                    <h5>IDENTIFICATION</h5>
                    <ul>
                      <li>
                        Scholars are identified formally for the Gifted and
                        Talented Program in the Fall of 2nd Grade through the
                        South Carolina CogAT/ITBS Assessments.
                      </li>
                      <li>
                        Scholars in 5k-4th are also identified as accelerated
                        through formative assessments such as Amplify Reading 3D
                        and MAP as well as teacher recommendations.
                      </li>
                      <li>
                        We look at a scholar’s academic/intellectual ability as
                        well as artistic potential in functioning at a high
                        performance level.
                      </li>
                      <h6>
                      ...
                      <ol>
                        <li>
                          Enrichment opportunities for GT identified children
                          and other scholars excelling in certain subjects/areas
                          in all grades 1st-4th.
                        </li>
                ...
                <Accordion.Item eventKey="3">
                  ...
                  <Accordion.Body>
                    <p>
                      Special instruction is made available to meet the needs of
                      our children who qualify under the Individuals with
                      Disabilities Education Act (IDEA). Scholars are served in
                      settings appropriate for their disabilities. All
                      information pertaining to services supplied through
                      Special Education will only be released to individuals who
                      have direct contact with the scholar and parent/guardian.
                      Please inform the school of any special services your
                      child has received prior to coming to Legacy. The
                      guidelines followed by Legacy Early College are those
                      established by local and federal mandates. Specific and
                ...
                <Accordion.Item eventKey="4">
                  ...
                  <Accordion.Body>
                    <p>
                      The Scholar Services Team at Legacy Early College
                      Elementary School consists of the scholar services
                      counselor, school social worker, and school psychologist.
                      The goal of this team is to provide scholars with
                      knowledge and support in the areas of academic
                      deficiencies, personal, social, and emotional development,
                      to promote positive mental health, and to assist scholars
                      in acquiring and using life skills. This is accomplished
                      through a comprehensive support program including
                      individual counseling, small group counseling, and
                      classroom lessons. Additionally, our team provides teacher
                      and parent consulting on an as-needed basis. Our scholar
                      services team may be contacted through our school office
                      at 864-214-1600.
                    </p>
                  </Accordion.Body>
                </Accordion.Item>{" "}
