        ...
        <ul className="offset-md-7 other-links ">
          ...
          <div className="d-flex">
            ...
            <div className="col-md-6">
              {" "}
              <Link to={"/inquire"}>
                import {FaPersonCircleCheck} from "react-icons/fa6"; Careers
              </Link>
              <br />
              <Link to={"/inquire"}>Campus Map</Link> <br />
              <Link to={"/inquire"}>School Store</Link> <br />
              <Link to={"/inquire"}>Reporting Resources</Link>
            </div>
          </div>
        </ul>
      </div>
