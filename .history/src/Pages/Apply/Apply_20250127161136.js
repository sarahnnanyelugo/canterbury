              ...
              <div className={`panel ${checkActive(1, "active2")}`}>
                <div className="col-md-12 steps-div">
                  ...
                  <p>
                    ...
                    boarding or day, we will request information about past and
                    present academic performance and personal interests.{" "}
                  </p>
                  <p>
                  ...
                  <p>
                    If you are unsure about anything or have a question, please
                    do not hesitate to reach out to us - we're here to help!{" "}
                  </p>
                </div>
              </div>
