      ...
      <div className="business-pricing-tab ">
        ...
        <div className="panels" ref={tabRef}>
          <div className={`panel ${activeIndex === 1 ? "active2" : ""}`}>
            <div
              className="d-md-flex col-md-8 offset-md-1"
              style={{
                transform:
            ...
            >
              <div className="tab-img1 col-md-4">
                <img src={Health} width="100%" />{" "}
                <div class="overlay2">
                  <div class="text">Healthy Connections</div>
                </div>
              </div>
              <div className="middle-img col-md-5 ">
                {" "}
                <img src={Vibrant} width="100%" />
                <div class="overlay">
                  <div class="text">
                    <p>A Vibrant Community</p>
                  </div>
                </div>
              </div>
              <div className="tab-img2 col-md-4">
                {" "}
                <img src={New} width="100%" />
                <div class="overlay2">
                  <div class="text">Try Something New</div>
                </div>
              </div>
            </div>
          </div>
