...
export const Home = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const scaleValue = Math.min(0.5 + (scrollY / maxScroll) * 1.5, 1); // Rapid scaling to 100%
  ...
  const calcScale = function (scale) {
    alert(scale);
    if (scale <= 0.3) return scale * 100;
    if (scale <= 0.7) return scale * 500;
    return scale * 1200;
  };
      ...
      <div className="home-div">
        ...
        <div className="col-md-12 d-flex">
          ...
          <div
            ...
            style={{
              width: `${scale <= 0.9 ? scale * 100 : scale * 600}%`,
              height: `${scale * 100}vh`,
