    ...
    <>
      <Desktop>
        ...
        >
          <div className="heading-container " ref={headingRef}>
            <div className="d-flex section-head offset-md-3">
              {" "}
              <h1 className="head1">THIS IS</h1> {""}
      ...
      <TabletAndBelow>
        ...
        <div
          ...
          className=" intro-introd-flex justify-content-center align-items-center"
        >
          <div
            style={{ opacity: "1" }}
            className="d-flex justify-content-center"
        ...
        <div
          className="col-md-12"
          style={{ background: "#fff", height: "300px", marginTop: "100px" }}
        >
