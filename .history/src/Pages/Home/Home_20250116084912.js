  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: "#fff" }}>
        ...
        <center>
          {" "}
          <div className="col-md-7 purpose d-flex">
            <p
              style={{
                transform: inViewText ? "scale(0.5)" : "scale(1)",
                opacity: inViewText ? 1 : 0,
                transition: "transform 2s ease, opacity 2s ease",
              }}
            >
              
            </p>
