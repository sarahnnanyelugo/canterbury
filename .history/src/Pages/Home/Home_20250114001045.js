...
export const Home = () => {
  ...
  const calcScale = function (scale) {
    console.log(scale);
    if (scale <= 0.58) return scale * 100;
    if (scale <= 0.7) return scale * 350;
    if (scale <= 0.8) return scale * 350;
    if (scale <= 0.9) return scale * 400;
    return scale * 500;
  };
  ...
  return (
    <>
      <div className="home-div">
        ...
        <div className="col-md-12 d-flex d-flex-column">
          {/* Left images */}
          {!hideImages && (
            <div
