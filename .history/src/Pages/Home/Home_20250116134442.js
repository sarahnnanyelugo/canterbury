  ...
  return (
    <>
      ...
      <div className="discover">
        ...
        <div className="culture-container " ref={headingRef}>
          <div className="d-flex offset-md-3">
            {" "}
            <h1
              className="heading1"
          ...
          <center>
            <div className="col-md-6">
              ...
              >
                ...
                experience a connection with peers and faculty, a curiosity
                about the things that make us different, and comfort in a
                community that celebrates you as an individual and bonds
