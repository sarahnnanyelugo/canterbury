      ...
      <div className="story-div col-md-12">
        ...
        <div className="col-md-8 offset-md-2 d-flex mission-values">
          ...
          <div className="col-md-8 row row-cols-2 row-cols-lg-2 g-2 g-lg-5">
            ...
            <Values
              photo={Res}
              heading="HONOR"
              text="Baylor students act with honor, integrity, responsibility, and conviction of character in all aspects of their daily life."
            />
          </div>
        </div>{" "}
        <div className="col-md-8 offset-md-2 row row-cols-2 row-cols-lg-3 g-2 g-lg-5 mt-1">
          <Values
            ...
            heading="POSITIVITY
"
            text="Baylor students embrace and create opportunities to make a positive difference in their communities and in the world.
...
"
          ...
          <Values
            ...
            heading="EMPATHY
"
            src="../../../assets/images/empathy.webp"
            text="Baylor students care for, understand, and respect the humanity of all members of the global community.
...
"
          ...
          <Values
            photo={Curious}
            heading="CURIOSITY"
            text="Baylor students seek knowledge and pursue a deeper understanding of the world.
