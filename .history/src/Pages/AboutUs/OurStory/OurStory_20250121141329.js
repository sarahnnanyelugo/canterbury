  ...
  return (
    <>
      <div className="story-div col-md-12">
        ...
        <div className="profile-caru col-md-8 offset-md-1">
          <div className="d-md-flex">
            <div className="col-md-8 profile-img offset-md-1">
            ...
            <div className="col-md-6 profile-details">
              ...
              <p>
                {" "}
                Beyond encouraging imaginative ideas, we challenge you to become
                a creative and critical thinker. In our classrooms, you&#39;ll
                learn to move beyond surface-level solutions, exploring complex
                problems from various angles, conducting rigorous analysis, and
                crafting innovative solutions. This approach equips you to adapt
                to evolving challenges and become a resourceful problem solver
                and leader in your chosen field.
              </p>
            </div>
          </div>
        </div>
